                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" v-model="form.title"
                                                    :class="{ 'is-invalid': errors.title }" type="text" placeholder="">
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" v-model="form.stock"
                                                    :class="{ 'is-invalid': errors.stock }" type="number" placeholder="">
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" v-model="form.buy_price"
                                                    :class="{ 'is-invalid': errors.buy_price }" type="number" placeholder="">
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" v-model="form.sell_price"
                                                    :class="{ 'is-invalid': errors.sell_price }" type="number" placeholder="">
                                            </div>
